...
UpdateESDE:
{
	msgbox, 305, First Run Setup, First run detected:`n`n Please select`n`n "EmulationStation-DE-[X.Y.Z]-x64_Portable.zip"`n`nfrom `n`nhttps://es-de.org/#Download `n`nTo apply update
	IfMsgBox, OK
	{
		FileSelectFile, ESDEzip, 3, ::{20d04fe0-3aea-1069-a2d8-08002b30309d}, Please Select "EmulationStation-DE-[X.Y.Z]-x64_Portable.zip", EmulationStation-DE-*-x64_Portable.zip
		if ( ESDEzip = "")
